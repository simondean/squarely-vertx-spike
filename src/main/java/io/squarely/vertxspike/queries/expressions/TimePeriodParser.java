...
public class TimePeriodParser {
  ...
  private static final BigDecimal MILLISECONDS_PER_MILLISECOND = new BigDecimal(1l);
  ...
  public static long parseTimePeriodToMillis(String value) {
  ...
  private static BigDecimal getMicrosecondsPerUnit(String unit) {
    switch (unit) {
      case UNIT_MICROSECONDS:
        return MILLISECONDS_PER_MILLISECOND;
      case UNIT_SECONDS:
